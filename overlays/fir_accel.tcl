...
proc create_hier_cell_filter { parentCell nameHier } {
  ...
  set_property -dict [list \
    CONFIG.Clock_Frequency {360} \
    CONFIG.CoefficientVector {161,   622,   636,   183,   -844,   -1652,   -1195,   1146,   4835,   8262,   9658,   8262,   4835,   1146,   -1195,   -1652,   -844,   183,   636,   622,   161} \
  ...
  connect_bd_intf_net -intf_net axi_smc_M00_AXI [get_bd_intf_pins S_AXI_LITE] [get_bd_intf_pins fir_dma/S_AXI_LITE]
  connect_bd_intf_net -intf_net low_pass_filter_M_AXIS_DATA [get_bd_intf_pins fir/M_AXIS_DATA] [get_bd_intf_pins fir_dma/S_AXIS_S2MM]

  # Create port connections
  connect_bd_net -net processing_system7_0_FCLK_CLK0  [get_bd_pins aclk] \
  [get_bd_pins fir/aclk] \
  [get_bd_pins fir_dma/m_axi_s2mm_aclk] \
  [get_bd_pins fir_dma/m_axi_mm2s_aclk] \
  [get_bd_pins fir_dma/s_axi_lite_aclk]
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn  [get_bd_pins axi_resetn] \
  [get_bd_pins fir_dma/axi_resetn]
...
\
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net axi_dma_0_M_AXI_MM2S [get_bd_intf_pins filter/M_AXI_MM2S] [get_bd_intf_pins axi_mem_intercon/S00_AXI]
  connect_bd_intf_net -intf_net axi_dma_0_M_AXI_S2MM [get_bd_intf_pins filter/M_AXI_S2MM] [get_bd_intf_pins axi_mem_intercon/S01_AXI]
  ...
  [get_bd_pins filter/axi_resetn]

  # Create address segments
  assign_bd_address -offset 0x40400000 -range 0x00010000 -with_name SEG_axi_dma_0_Reg -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs filter/fir_dma/S_AXI_LITE/Reg] -force
  assign_bd_address -offset 0x00000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces filter/fir_dma/Data_MM2S] [get_bd_addr_segs processing_system7_0/S_AXI_HP0/HP0_DDR_LOWOCM] -force
  assign_bd_address -offset 0x00000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces filter/fir_dma/Data_S2MM] [get_bd_addr_segs processing_system7_0/S_AXI_HP0/HP0_DDR_LOWOCM] -force
